...
const i2s_port_t I2S_PORT_INMP441 = I2S_NUM_1;        // I2S外设INMP441端口号为1
const i2s_port_t I2S_PORT_MAX98357A = I2S_NUM_0;      // I2S外设MAX98357A端口号为0

extern int16_t s_buffer[bufferlen];                 // 采样数据缓冲区
